...
class Instructions
{
    ...
    public static void add(int i, LuaVM vm) { binaryArith(i, vm, ArithOp.LUA_OPADD); } // +
    public static void sub(int i, LuaVM vm) { binaryArith(i, vm, ArithOp.LUA_OPSUB); } // -
    public static void mul(int i, LuaVM vm) { binaryArith(i, vm, ArithOp.LUA_OPMUL); } // *
    public static void mod(int i, LuaVM vm) { binaryArith(i, vm, ArithOp.LUA_OPMOD); } // %
    public static void pow(int i, LuaVM vm) { binaryArith(i, vm, ArithOp.LUA_OPPOW); } // ^
    public static void div(int i, LuaVM vm) { binaryArith(i, vm, ArithOp.LUA_OPDIV); } // /
    public static void idiv(int i, LuaVM vm) { binaryArith(i, vm, ArithOp.LUA_OPIDIV); } // //
    public static void band(int i, LuaVM vm) { binaryArith(i, vm, ArithOp.LUA_OPBAND); } // &
    public static void bor(int i, LuaVM vm) { binaryArith(i, vm, ArithOp.LUA_OPBOR); } // |
    public static void bxor(int i, LuaVM vm) { binaryArith(i, vm, ArithOp.LUA_OPBXOR); } // ~
    public static void shl(int i, LuaVM vm) { binaryArith(i, vm, ArithOp.LUA_OPSHL); } // <<
    public static void shr(int i, LuaVM vm) { binaryArith(i, vm, ArithOp.LUA_OPSHR); } // >>
    public static void unm(int i, LuaVM vm) { unaryArith(i, vm, ArithOp.LUA_OPUNM); } // -
    public static void bnot(int i, LuaVM vm) { unaryArith(i, vm, ArithOp.LUA_OPBNOT); } // ~
    ...
    public static void eq(int i, LuaVM vm) { compare(i, vm, CmpOp.LUA_OPEQ); } // ==
    public static void lt(int i, LuaVM vm) { compare(i, vm, CmpOp.LUA_OPLT); } // <
    public static void le(int i, LuaVM vm) { compare(i, vm, CmpOp.LUA_OPLE); } // <=
    ...
    public static void forPrep(int i, LuaVM vm)
    {
        ...
        if (vm.type(a) == LuaType.LUA_TSTRING)
        {
            vm.pushNumber(vm.toNumber(a));
            vm.replace(a);
        }
        if (vm.type(a + 1) == LuaType.LUA_TSTRING)
        {
            vm.pushNumber(vm.toNumber(a + 1));
            vm.replace(a + 1);
        }
        if (vm.type(a + 2) == LuaType.LUA_TSTRING)
        {
    ...
    public static void forLoop(int i, LuaVM vm)
    {
        ...
        if (isPositiveStep && vm.compare(a, a + 1, CmpOp.LUA_OPLE) ||
                !isPositiveStep && vm.compare(a + 1, a, CmpOp.LUA_OPLE))
        {
            // pc+=sBx; R(A+3)=R(A)
            vm.addPC(sBx);
            vm.copy(a, a + 3);
