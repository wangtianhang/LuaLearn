...
#define __una_u64 uint64_t
#define __una_u32 uint32_t
#define __una_u16 uint16_t
#define __una_64 int64_t
#define __una_32 int32_t
#define __una_16 int16_t
#define __una_f float
#define __una_d double
...
{        
    ...
    switch(format)
    {
        ...
        case 'q':
            {
                char temp[64];
                int64_t n = (unpack_fixed64(buffer, out));
